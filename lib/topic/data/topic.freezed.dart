...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  int creatorId,  String creator,  DateTime createdAt,  int updaterId,  String updater,  DateTime updatedAt,  String title,  int responseCount,  bool sticky,  bool locked,  bool hidden,  int categoryId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Topic() when $default != null:
return $default(_that.id,_that.creatorId,_that.creator,_that.createdAt,_that.updaterId,_that.updater,_that.updatedAt,_that.title,_that.responseCount,_that.sticky,_that.locked,_that.hidden,_that.categoryId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  int creatorId,  String creator,  DateTime createdAt,  int updaterId,  String updater,  DateTime updatedAt,  String title,  int responseCount,  bool sticky,  bool locked,  bool hidden,  int categoryId)  $default,) {final _that = this;
switch (_that) {
case _Topic():
return $default(_that.id,_that.creatorId,_that.creator,_that.createdAt,_that.updaterId,_that.updater,_that.updatedAt,_that.title,_that.responseCount,_that.sticky,_that.locked,_that.hidden,_that.categoryId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  int creatorId,  String creator,  DateTime createdAt,  int updaterId,  String updater,  DateTime updatedAt,  String title,  int responseCount,  bool sticky,  bool locked,  bool hidden,  int categoryId)?  $default,) {final _that = this;
switch (_that) {
case _Topic() when $default != null:
return $default(_that.id,_that.creatorId,_that.creator,_that.createdAt,_that.updaterId,_that.updater,_that.updatedAt,_that.title,_that.responseCount,_that.sticky,_that.locked,_that.hidden,_that.categoryId);case _:
  return null;

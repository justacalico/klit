...
/// Unified favorites page - single file for all layouts.
class UiFavoritesPage extends StatefulWidget {
  final Function(PostDetailArguments) onPostTap;

  const UiFavoritesPage({super.key, required this.onPostTap});

  @override
  State<UiFavoritesPage> createState() => _UiFavoritesPageState();
}

class _UiFavoritesPageState extends State<UiFavoritesPage> {

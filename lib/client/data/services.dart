...
/// A container for all API and database service clients for a single identity.
///
/// This is separated from the main client facade so construction logic can
/// live on its own and the consumer stays focused.
class ClientServices with Disposable {
  ClientServices({
    required this.dio,

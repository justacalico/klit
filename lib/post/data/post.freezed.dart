...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String? file,  String? sample,  String? preview,  int width,  int height,  String ext,  int size,  Map<String, String?>? variants,  Map<String, List<String>> tags,  int uploaderId,  String? uploaderName,  DateTime createdAt,  DateTime? updatedAt,  int? changeSeq,  int? approverId,  VoteInfo vote,  bool isDeleted,  Rating rating,  int favCount,  bool isFavorited,  int commentCount,  String description,  List<String> sources,  List<int>? pools,  List<String>? lockedTags,  Relationships relationships)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Post() when $default != null:
return $default(_that.id,_that.file,_that.sample,_that.preview,_that.width,_that.height,_that.ext,_that.size,_that.variants,_that.tags,_that.uploaderId,_that.uploaderName,_that.createdAt,_that.updatedAt,_that.changeSeq,_that.approverId,_that.vote,_that.isDeleted,_that.rating,_that.favCount,_that.isFavorited,_that.commentCount,_that.description,_that.sources,_that.pools,_that.lockedTags,_that.relationships);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String? file,  String? sample,  String? preview,  int width,  int height,  String ext,  int size,  Map<String, String?>? variants,  Map<String, List<String>> tags,  int uploaderId,  String? uploaderName,  DateTime createdAt,  DateTime? updatedAt,  int? changeSeq,  int? approverId,  VoteInfo vote,  bool isDeleted,  Rating rating,  int favCount,  bool isFavorited,  int commentCount,  String description,  List<String> sources,  List<int>? pools,  List<String>? lockedTags,  Relationships relationships)  $default,) {final _that = this;
switch (_that) {
case _Post():
return $default(_that.id,_that.file,_that.sample,_that.preview,_that.width,_that.height,_that.ext,_that.size,_that.variants,_that.tags,_that.uploaderId,_that.uploaderName,_that.createdAt,_that.updatedAt,_that.changeSeq,_that.approverId,_that.vote,_that.isDeleted,_that.rating,_that.favCount,_that.isFavorited,_that.commentCount,_that.description,_that.sources,_that.pools,_that.lockedTags,_that.relationships);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String? file,  String? sample,  String? preview,  int width,  int height,  String ext,  int size,  Map<String, String?>? variants,  Map<String, List<String>> tags,  int uploaderId,  String? uploaderName,  DateTime createdAt,  DateTime? updatedAt,  int? changeSeq,  int? approverId,  VoteInfo vote,  bool isDeleted,  Rating rating,  int favCount,  bool isFavorited,  int commentCount,  String description,  List<String> sources,  List<int>? pools,  List<String>? lockedTags,  Relationships relationships)?  $default,) {final _that = this;
switch (_that) {
case _Post() when $default != null:
return $default(_that.id,_that.file,_that.sample,_that.preview,_that.width,_that.height,_that.ext,_that.size,_that.variants,_that.tags,_that.uploaderId,_that.uploaderName,_that.createdAt,_that.updatedAt,_that.changeSeq,_that.approverId,_that.vote,_that.isDeleted,_that.rating,_that.favCount,_that.isFavorited,_that.commentCount,_that.description,_that.sources,_that.pools,_that.lockedTags,_that.relationships);case _:
  return null;
...
/// Adds pattern-matching-related methods to [Relationships].
extension RelationshipsPatterns on Relationships {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Relationships value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _Relationships() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Relationships value)  $default,){
final _that = this;
switch (_that) {
case _Relationships():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Relationships value)?  $default,){
final _that = this;
switch (_that) {
case _Relationships() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? parentId,  bool hasChildren,  bool? hasActiveChildren,  List<int> children)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Relationships() when $default != null:
return $default(_that.parentId,_that.hasChildren,_that.hasActiveChildren,_that.children);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? parentId,  bool hasChildren,  bool? hasActiveChildren,  List<int> children)  $default,) {final _that = this;
switch (_that) {
case _Relationships():
return $default(_that.parentId,_that.hasChildren,_that.hasActiveChildren,_that.children);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? parentId,  bool hasChildren,  bool? hasActiveChildren,  List<int> children)?  $default,) {final _that = this;
switch (_that) {
case _Relationships() when $default != null:
return $default(_that.parentId,_that.hasChildren,_that.hasActiveChildren,_that.children);case _:
  return null;

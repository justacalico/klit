...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name,  DateTime createdAt,  DateTime updatedAt,  String description,  List<int> postIds,  int postCount,  bool active)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Pool() when $default != null:
return $default(_that.id,_that.name,_that.createdAt,_that.updatedAt,_that.description,_that.postIds,_that.postCount,_that.active);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name,  DateTime createdAt,  DateTime updatedAt,  String description,  List<int> postIds,  int postCount,  bool active)  $default,) {final _that = this;
switch (_that) {
case _Pool():
return $default(_that.id,_that.name,_that.createdAt,_that.updatedAt,_that.description,_that.postIds,_that.postCount,_that.active);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name,  DateTime createdAt,  DateTime updatedAt,  String description,  List<int> postIds,  int postCount,  bool active)?  $default,) {final _that = this;
switch (_that) {
case _Pool() when $default != null:
return $default(_that.id,_that.name,_that.createdAt,_that.updatedAt,_that.description,_that.postIds,_that.postCount,_that.active);case _:
  return null;

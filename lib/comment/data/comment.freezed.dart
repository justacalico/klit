...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  int postId,  String body,  DateTime createdAt,  DateTime updatedAt,  int creatorId,  String creatorName,  VoteInfo? vote,  WarningType? warning,  bool hidden)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Comment() when $default != null:
return $default(_that.id,_that.postId,_that.body,_that.createdAt,_that.updatedAt,_that.creatorId,_that.creatorName,_that.vote,_that.warning,_that.hidden);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  int postId,  String body,  DateTime createdAt,  DateTime updatedAt,  int creatorId,  String creatorName,  VoteInfo? vote,  WarningType? warning,  bool hidden)  $default,) {final _that = this;
switch (_that) {
case _Comment():
return $default(_that.id,_that.postId,_that.body,_that.createdAt,_that.updatedAt,_that.creatorId,_that.creatorName,_that.vote,_that.warning,_that.hidden);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  int postId,  String body,  DateTime createdAt,  DateTime updatedAt,  int creatorId,  String creatorName,  VoteInfo? vote,  WarningType? warning,  bool hidden)?  $default,) {final _that = this;
switch (_that) {
case _Comment() when $default != null:
return $default(_that.id,_that.postId,_that.body,_that.createdAt,_that.updatedAt,_that.creatorId,_that.creatorName,_that.vote,_that.warning,_that.hidden);case _:
  return null;

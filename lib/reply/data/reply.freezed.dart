...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  int creatorId,  String creator,  DateTime createdAt,  int? updaterId,  String? updater,  DateTime updatedAt,  String body,  int topicId,  WarningType? warning,  bool hidden)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Reply() when $default != null:
return $default(_that.id,_that.creatorId,_that.creator,_that.createdAt,_that.updaterId,_that.updater,_that.updatedAt,_that.body,_that.topicId,_that.warning,_that.hidden);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  int creatorId,  String creator,  DateTime createdAt,  int? updaterId,  String? updater,  DateTime updatedAt,  String body,  int topicId,  WarningType? warning,  bool hidden)  $default,) {final _that = this;
switch (_that) {
case _Reply():
return $default(_that.id,_that.creatorId,_that.creator,_that.createdAt,_that.updaterId,_that.updater,_that.updatedAt,_that.body,_that.topicId,_that.warning,_that.hidden);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  int creatorId,  String creator,  DateTime createdAt,  int? updaterId,  String? updater,  DateTime updatedAt,  String body,  int topicId,  WarningType? warning,  bool hidden)?  $default,) {final _that = this;
switch (_that) {
case _Reply() when $default != null:
return $default(_that.id,_that.creatorId,_that.creator,_that.createdAt,_that.updaterId,_that.updater,_that.updatedAt,_that.body,_that.topicId,_that.warning,_that.hidden);case _:
  return null;

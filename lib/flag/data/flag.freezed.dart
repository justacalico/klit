...
/// Adds pattern-matching-related methods to [PostFlag].
extension PostFlagPatterns on PostFlag {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _PostFlag value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _PostFlag() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _PostFlag value)  $default,){
final _that = this;
switch (_that) {
case _PostFlag():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _PostFlag value)?  $default,){
final _that = this;
switch (_that) {
case _PostFlag() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  DateTime createdAt,  int postId,  String reason,  int creatorId,  bool isResolved,  DateTime updatedAt,  bool isDeletion,  PostFlagType type)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PostFlag() when $default != null:
return $default(_that.id,_that.createdAt,_that.postId,_that.reason,_that.creatorId,_that.isResolved,_that.updatedAt,_that.isDeletion,_that.type);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  DateTime createdAt,  int postId,  String reason,  int creatorId,  bool isResolved,  DateTime updatedAt,  bool isDeletion,  PostFlagType type)  $default,) {final _that = this;
switch (_that) {
case _PostFlag():
return $default(_that.id,_that.createdAt,_that.postId,_that.reason,_that.creatorId,_that.isResolved,_that.updatedAt,_that.isDeletion,_that.type);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  DateTime createdAt,  int postId,  String reason,  int creatorId,  bool isResolved,  DateTime updatedAt,  bool isDeletion,  PostFlagType type)?  $default,) {final _that = this;
switch (_that) {
case _PostFlag() when $default != null:
return $default(_that.id,_that.createdAt,_that.postId,_that.reason,_that.creatorId,_that.isResolved,_that.updatedAt,_that.isDeletion,_that.type);case _:
  return null;

...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  DateTime visitedAt,  String link,  HistoryCategory category,  HistoryType type,  String? title,  String? subtitle,  List<String> thumbnails)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _History() when $default != null:
return $default(_that.id,_that.visitedAt,_that.link,_that.category,_that.type,_that.title,_that.subtitle,_that.thumbnails);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  DateTime visitedAt,  String link,  HistoryCategory category,  HistoryType type,  String? title,  String? subtitle,  List<String> thumbnails)  $default,) {final _that = this;
switch (_that) {
case _History():
return $default(_that.id,_that.visitedAt,_that.link,_that.category,_that.type,_that.title,_that.subtitle,_that.thumbnails);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  DateTime visitedAt,  String link,  HistoryCategory category,  HistoryType type,  String? title,  String? subtitle,  List<String> thumbnails)?  $default,) {final _that = this;
switch (_that) {
case _History() when $default != null:
return $default(_that.id,_that.visitedAt,_that.link,_that.category,_that.type,_that.title,_that.subtitle,_that.thumbnails);case _:
  return null;
...
/// Adds pattern-matching-related methods to [HistoryRequest].
extension HistoryRequestPatterns on HistoryRequest {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _HistoryRequest value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _HistoryRequest() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _HistoryRequest value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _HistoryRequest value)?  $default,){
final _that = this;
switch (_that) {
case _HistoryRequest() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( DateTime visitedAt,  String link,  HistoryCategory category,  HistoryType type,  String? title,  String? subtitle,  List<String> thumbnails)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _HistoryRequest() when $default != null:
return $default(_that.visitedAt,_that.link,_that.category,_that.type,_that.title,_that.subtitle,_that.thumbnails);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( DateTime visitedAt,  String link,  HistoryCategory category,  HistoryType type,  String? title,  String? subtitle,  List<String> thumbnails)  $default,) {final _that = this;
switch (_that) {
case _HistoryRequest():
return $default(_that.visitedAt,_that.link,_that.category,_that.type,_that.title,_that.subtitle,_that.thumbnails);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( DateTime visitedAt,  String link,  HistoryCategory category,  HistoryType type,  String? title,  String? subtitle,  List<String> thumbnails)?  $default,) {final _that = this;
switch (_that) {
case _HistoryRequest() when $default != null:
return $default(_that.visitedAt,_that.link,_that.category,_that.type,_that.title,_that.subtitle,_that.thumbnails);case _:
  return null;

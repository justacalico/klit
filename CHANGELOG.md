...
# 12.0.0
- Added selected state styling (primary color, bold text) to top nav tiles, tooltips to collapsed sidebar items, and selected item highlighting in the bottom nav More menu ([!78](https://gitlab.com/Openlyst/klit/-/merge_requests/78))

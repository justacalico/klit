...
# 12.0.0
- Added form validation to the feed editor: the feed name field is now required and shows an error message when empty ([!82](https://gitlab.com/Openlyst/klit/-/merge_requests/82))

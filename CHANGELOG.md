...
# 12.0.0
- Replaced hardcoded English empty and error messages in post search and detail gallery views with localized strings ([!70](https://gitlab.com/Openlyst/klit/-/merge_requests/70))

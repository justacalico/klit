...
# 12.0.0
- Replaced hardcoded English strings on the Finishes page with localized strings and added a loading state for the stream builder ([!72](https://gitlab.com/Openlyst/klit/-/merge_requests/72))

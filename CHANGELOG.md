...
# 12.0.0
- Replaced hardcoded English strings in database management, feeds delete dialog, context drawer tooltip, and history limit dialog with localized strings ([!73](https://gitlab.com/Openlyst/klit/-/merge_requests/73))

...
# 12.0.0
- Added tooltips to icon-only buttons in post feed tiles (comment, share) and finishes page delete button for accessibility ([!81](https://gitlab.com/Openlyst/klit/-/merge_requests/81))

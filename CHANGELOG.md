...
# 12.0.0
- Added a loading indicator to pool tiles while thumbnail posts are being fetched, instead of showing nothing ([!83](https://gitlab.com/Openlyst/klit/-/merge_requests/83))

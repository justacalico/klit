...
# 12.0.0
- Replaced hardcoded English strings in post detail loading page, image toggle, and fullscreen action pills with localized strings ([!71](https://gitlab.com/Openlyst/klit/-/merge_requests/71))

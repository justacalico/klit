...
# 12.0.0
- Fixed favorites page loading state: shows a loading indicator while fetching instead of rendering immediately, and shows an empty state when the favorites list is loaded but empty ([!79](https://gitlab.com/Openlyst/klit/-/merge_requests/79))

...
# 12.0.0
- Added confirmation dialogs for destructive actions: deleting a finish, deleting selected history entries, and deleting a single history entry ([!80](https://gitlab.com/Openlyst/klit/-/merge_requests/80))
